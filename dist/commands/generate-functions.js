...
/**
 * Generates handlers.ts file for easier frontend consumption
 */
function generateHandlersFile(allPaths, outputDir) {
    const handlersContent = `// Auto-generated handlers for easy frontend consumption
...
${Object.entries(allPaths)
        ...
        .join('\n')}
`;
    fs_1.default.writeFileSync(path_1.default.join(outputDir, 'handlers.ts'), handlersContent);
}
async function generateFunctions() {
    ...
    generateHandlersFile(allPaths, outputDir);
